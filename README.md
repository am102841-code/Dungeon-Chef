...
**Dungeon Chef** is a 2D top-down survival and cooking game built with **Python** and **Pygame**. This game will include features similar to **Dungeon Platformer**, which is the main inspiration for **Dungeon Chef** along with the manga series **Delicious in Dungeon**. Players explore a dangerous dungeon, avoid monsters, manage their health, and gather resources while working toward becoming the ultimate dungeon chef.
